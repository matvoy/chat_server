...
protoc -I api/proto/entity -I api/proto/chat --go_out=api/proto/chat --micro_out=api/proto/chat api/proto/chat/chat.proto
...
protoc -I api/proto/entity -I api/proto/bot --go_out=api/proto/bot --micro_out=api/proto/bot api/proto/bot/bot.proto
