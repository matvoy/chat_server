...
type Profile struct {
	...
	SchemaID  null.Int64 `boil:"schema_id" json:"schema_id,omitempty" toml:"schema_id" yaml:"schema_id,omitempty"`
	Type      string     `boil:"type" json:"type" toml:"type" yaml:"type"`
	Variables types.JSON `boil:"variables" json:"variables" toml:"variables" yaml:"variables"`
...
var ProfileWhere = struct {
	...
	SchemaID  whereHelpernull_Int64
	Type      whereHelperstring
	Variables whereHelpertypes_JSON
	DomainID  whereHelperint64
}{
	ID:        whereHelperint64{field: "\"chat\".\"profile\".\"id\""},
	Name:      whereHelperstring{field: "\"chat\".\"profile\".\"name\""},
	SchemaID:  whereHelpernull_Int64{field: "\"chat\".\"profile\".\"schema_id\""},
	Type:      whereHelperstring{field: "\"chat\".\"profile\".\"type\""},
	Variables: whereHelpertypes_JSON{field: "\"chat\".\"profile\".\"variables\""},
	DomainID:  whereHelperint64{field: "\"chat\".\"profile\".\"domain_id\""},
}
...
var (
	...
	profileColumnsWithoutDefault = []string{"name", "schema_id", "type", "variables", "domain_id"}
...
func Profiles(mods ...qm.QueryMod) profileQuery {
	mods = append(mods, qm.From("\"chat\".\"profile\""))
...
func FindProfile(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Profile, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"chat\".\"profile\" where \"id\"=$1", sel,
	)
...
func (o *Profile) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"chat\".\"profile\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"chat\".\"profile\" %sDEFAULT VALUES%s"
		}
...
func (o *Profile) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"chat\".\"profile\" SET %s WHERE %s",
...
func (o ProfileSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"chat\".\"profile\" SET %s WHERE %s",
...
func (o *Profile) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"chat\".\"profile\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *Profile) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"chat\".\"profile\" WHERE \"id\"=$1"
...
func (o ProfileSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"chat\".\"profile\" WHERE " +
...
func (o *ProfileSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"chat\".\"profile\".* FROM \"chat\".\"profile\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, profilePrimaryKeyColumns, len(*o))
...
func ProfileExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"chat\".\"profile\" where \"id\"=$1 limit 1)"
